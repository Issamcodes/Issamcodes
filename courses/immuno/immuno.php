...
<body>
  <div class="background-image">
      <h3 class="background-image2" style="color:white; text-decoration: underline; position: absolute; top:15px; margin:0px 10px 10px 15px;padding:3px 5px 5px 16px; border:3px solid black; height:50px; width:250px;">IMMUNOLOGIE:</h3>
