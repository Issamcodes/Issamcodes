...
<body>
  <div class="background-image">
   <h3 class="background-image3" style="color:white; text-decoration: underline; position: absolute; top:15px; margin:0px 10px 10px 15px;padding:4px 5px 5px 15px; border:3px solid black; height:50px; width:250px;">HEMOBIOLOGIE:</h3>
